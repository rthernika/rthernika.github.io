          ...
          <div className="space-y-6 text-sm sm:text-base leading-relaxed text-stone-600 dark:text-stone-300">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 marker:text-emerald-600 dark:marker:text-emerald-400">
                <li>
                  <strong>Personal Details:</strong> Your full name, email address, phone number, and location.
                </li>
                <li>
                  <strong>Booking Information:</strong> Session appointments, preferred time slots, and consultation preferences scheduled through Cal.id.
                </li>
                <li>
                  <strong>Voluntary Intake Details:</strong> Any background information, concerns, or goals you share during pre-session forms or consultations.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                Thernika R (M.Sc Applied Psychology) operates under strict ethical guidelines for psychological practice:
              </p>
              <ul className="list-disc pl-6 space-y-2 marker:text-emerald-600 dark:marker:text-emerald-400">
                ...
                <li>
                  <strong>Legal & Emergency Exceptions:</strong> Confidentiality may only be breached if mandated by law or if there is imminent risk of harm to yourself or others.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-3 pt-4 border-t border-stone-200 dark:border-emerald-800/30">
              ...
              <div className="p-4 rounded-2xl bg-stone-50 dark:bg-[#0d1c15] border border-stone-200 dark:border-emerald-800/40 text-xs sm:text-sm font-mono text-stone-700 dark:text-stone-300 space-y-1.5">
                <p>
                  <strong>Purnam Counselling</strong>
                </p>
